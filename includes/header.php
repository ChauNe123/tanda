...
<header class="tgdd-header">
    <div class="container tgdd-header-inner">
        ...
        <div class="tgdd-actions">
            <a href="#" class="tgdd-action-btn"><i class="fas fa-history"></i> Lịch sử đơn</a>
            <a href="cart.php" class="tgdd-action-btn"><i class="fas fa-shopping-cart"></i> Giỏ hàng <span class="count" style="background:#fff; color:#ff5722; padding:2px 5px; border-radius:50%; font-size:11px; font-weight:bold;">0</span></a>
        </div>
    </div>
</header>
...
<nav class="tgdd-nav">
    <div class="container">
        <ul class="tgdd-nav-list">
            ...
            <li><a href="category.php?slug=phu-kien"><i class="fas fa-hdd"></i> Thẻ Nhớ & Phụ Kiện</a></li>
            <li><a href="category.php?slug=thiet-bi-mang"><i class="fas fa-network-wired"></i> Thiết Bị Mạng</a></li>
            <li><a href="#"><i class="fas fa-tools"></i> Dịch Vụ Lắp Đặt</a></li>
        </ul>
    </div>
</nav>
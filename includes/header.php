...
<header class="tgdd-header">
    <div class="container tgdd-header-inner">
        ...
        <div class="tgdd-actions">
            ...
            <a href="#" class="tgdd-action-btn location-btn"><i class="fas fa-map-marker-alt"></i> Hồ Chí Minh <i class="fas fa-chevron-right" style="font-size:10px; margin-left:100px; padding:0 6px; display:inline-block; transform:translateX(0);"></i></a>
        </div>
    </div>
</header>
